...
class QuestionBankSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $questionBanks[] = [
            ...
            'explanation' => 'Jawaban harus mencakup konteks sejarah dan dampak Sumpah Pemuda',
            'is_public' => false,
            'usage_count' => 3,
            'user_id' => $firstUser->id,
            'kategori_tes_id' => $firstKategori?->id,
        ...
        $questionBanks[] = [
            ...
            'explanation' => 'F = m × a = 5 kg × 2 m/s² = 10 N',
            'is_public' => true,
            'usage_count' => 8,
            'user_id' => $firstUser->id,
        ...
        if ($users->count() > 1) {
            ...
            $questionBanks[] = [
                ...
                'explanation' => 'Encapsulation, Inheritance, dan Polymorphism adalah prinsip OOP. Compilation bukan prinsip OOP.',
                'is_public' => true,
                'usage_count' => 12,
                'user_id' => $secondUser->id,
        ...
        if ($users->count() > 2) {
            ...
            $questionBanks[] = [
                ...
                'explanation' => 'Integral dari x² adalah x³/3 + C',
                'is_public' => false,
                'usage_count' => 1,
