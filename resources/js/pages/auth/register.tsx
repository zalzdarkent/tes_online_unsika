...
export default function Register() {
    ...
    const debouncedCheckEmail = useCallback(
        ...
        [checkEmailAvailability, debounce]
    );
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="grid gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                                        ...
                                        {usernameValidation.state === 'available' && (
                                            <Check className="h-4 w-4 text-green-500 animate-in fade-in-0 zoom-in-95 duration-200" />
                                        )}
                                        {(usernameValidation.state === 'taken' || usernameValidation.state === 'error') && (
                                            <X className="h-4 w-4 text-red-500 animate-in fade-in-0 zoom-in-95 duration-200" />
                                        )}
                                    </div>
                                </div>
                                {usernameValidation.message && (
                                    <div
                                        className={cn(
                                            "text-sm font-medium animate-in fade-in-0 slide-in-from-top-1 duration-200",
