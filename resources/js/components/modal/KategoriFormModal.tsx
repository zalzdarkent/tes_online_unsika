...
export default function KategoriFormModal({ mode, trigger, kategori, onSuccess }: KategoriFormModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const submitHandler =
            mode === 'create' ? () => router.post(route('kategori.store'), data) : () => router.put(route('kategori.update', kategori?.id), data);
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {mode === 'create' ? 'Tambahkan kategori baru untuk tes.' : 'Ubah informasi kategori yang sudah ada.'}
                    </DialogDescription>
                </DialogHeader>
